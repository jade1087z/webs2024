...
$boardSql = "SELECT * FROM drinkBoard WHERE boardDelete = 1 AND boardCategory = '자유게시판' AND memberId = '$memberId' ORDER BY boardId DESC";
$boardInfo = $connect->query($boardSql);
$result = $boardInfo->fetch_array(MYSQLI_ASSOC);
        ...
        <main id="contents_area">
            <section id="main_contents">
                ...
                <div class="best_list boxStyle roundCorner shaDow">
                    <h4><?= $result['boardAuthor'] ?>님의 게시글 모음 </h4>
                    <ul class="board_w100">
