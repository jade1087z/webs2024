...
<head>
    <?php
    include "../include/notScrollHead.php";
    ?>
...
<body class="join__body">
                ...
                <form action="joincollect.php" name="joincollect" method="post" onsubmit="return joinChecks();">
                    ...
                    <div>
                        ...
                        <div class="box">
                            ...
                            <input type="text" minlength="8" maxlength="20" name="youPass" placeholder="비밀번호 입력(문자, 숫자, 특수문자 포함 8~20)" id="youPass">
    ...
    <script>
        $("#youId, #youNick, #youEmail").change(function() {
            isIdCheck = false;
            isNickCheck = false;
            isEmailCheck = false;
        });
